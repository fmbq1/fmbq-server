...
curl -X POST http://192.168.1.52:8080/admin/signup \
...
curl -X GET http://192.168.1.52:8080/api/v1/admin/users \
  -H "Authorization: Bearer YOUR_ADMIN_TOKEN"

# Get user statistics
curl -X GET http://192.168.1.52:8080/api/v1/admin/users-stats \
  -H "Authorization: Bearer YOUR_ADMIN_TOKEN"

# Update user role
curl -X PUT http://192.168.1.52:8080/api/v1/admin/users/USER_ID/role \
  -H "Authorization: Bearer YOUR_ADMIN_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{"role": "employee"}'
```
