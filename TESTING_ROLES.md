...
curl -X POST http://192.168.0.131:8080/admin/signup \
...
curl -X GET http://192.168.0.131:8080/api/v1/admin/users \
  -H "Authorization: Bearer YOUR_ADMIN_TOKEN"

# Get user statistics
curl -X GET http://192.168.0.131:8080/api/v1/admin/users-stats \
  -H "Authorization: Bearer YOUR_ADMIN_TOKEN"
